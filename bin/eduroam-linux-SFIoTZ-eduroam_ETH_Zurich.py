...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " \
    "be overwritten"
Config.instname = "Swiss Federal Institute of Technology Zurich"
Config.profilename = "eduroam ETH Zurich"
Config.url = " \
    ""https://www.ethz.ch/services/en/it-services/service-desk.html"
Config.email = "servicedesk@id.ethz.ch"
Config.title = "eduroam CAT"
Config.server_match = "radius-service.ethz.ch"
...
Config.user_realm = "ethz.ch"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius-service.ethz.ch']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@ethz.ch"
Config.tou = ""
