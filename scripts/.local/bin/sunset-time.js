...
// Dependencies
const SunCalc = require ("suncalc"), Daty = require ("daty"),
      Prompt = require ("prompt"), IpInfo = require ("ipinfo"),
      rJson = require ("r-json"), wJson = require ("w-json"),
      splitByComma = require ("split-by-comma"),
      couleurs = require ("couleurs"), abs = require ("abs"),
      Tilda = require ("tilda");
...
new Tilda (`${__dirname}/package.json`, {
        ...
        function showSunset ()
        {
                ...
                let sunsetDate
                        = new Daty (SunCalc.getTimes(new Date (), config.lat,
                                                     config.lng)
                                            .sunset),
                ...
                // Thanks! :)
                // http://chris.com/ascii/index.php?art=nature/sunset
                console.log(`
                Sunset time today:
                     ${sunsetStr}
